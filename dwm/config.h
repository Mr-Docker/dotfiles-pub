...
static const char dmenufont[]       = "Hack Nerd Font Mono:style=Bold:size=16";
...
#define TAGKEYS(KEY,TAG)                                                                                                \
       &((Keychord){1, {{Mod1Mask, KEY}},                              view,           {.ui = 1 << TAG} }), \
       &((Keychord){1, {{Mod1Mask|ControlMask, KEY}},                      toggleview,     {.ui = 1 << TAG} }), \
       &((Keychord){1, {{Mod1Mask|ShiftMask, KEY}},                        tag,            {.ui = 1 << TAG} }), \
       &((Keychord){1, {{Mod1Mask|ControlMask|ShiftMask, KEY}},            toggletag,      {.ui = 1 << TAG} }),
...
static Keychord *keychords[] = {
    ...
    &((Keychord){1, {{Mod1Mask, XK_p}},               spawn,          {.v = dmenucmd } }),
    &((Keychord){1, {{Mod1Mask, XK_Return}}, spawn,       {.v = termcmd } }),
    ...
    &((Keychord){1, {{Mod1Mask, XK_q}},               killclient,     {0} }),
